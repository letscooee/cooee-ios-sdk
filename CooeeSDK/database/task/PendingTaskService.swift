...
class PendingTaskService {
    ...
    private static let PROCESSORS: [PendingTaskProcessor] = [EventTaskProcessor(), ProfileTaskProcessor(), DeviceTaskProcessor(), PushTokenTaskProcessor(), SessionConcludeTaskProcessor(), LogoutTaskProcessor()]
